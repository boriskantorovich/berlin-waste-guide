...
const flowchartData = {
    title: "Интерактивная блок-схема сортировки отходов в Берлине (актуально 2025)",
    ...
    steps: [
        {
            ...
            question: "Есть Pfand?",
            details: [
                "Еinweg-ПЭТ/алюминиевые банки – 0,25 €",
                "Mehrweg-пивные/лимонадные стекло – 0,08-0,15 €",
                "Пивные ящики – ≈1,50 €",
                "КФ-стартер-аккумулятор – 7,50 €"
            ],
            whereTo: "Любой супермаркет > 200 м², Getränke-маркет или Pfandautomat. Аккумуляторы – там же, где покупали, либо Recyclinghof.",
